...
static void next_put_letter(data_t *data)
{
    ...
    put_letter(data, 'R', (IntR_t) {125, 104, 7, 13}, (sfVector2f) {1037, 390});
    put_letter(data, 'S', (IntR_t) {142, 104, 6, 13}, (sfVector2f) {1157, 390});
    put_letter(data, 'T', (IntR_t) {158, 104, 8, 13}, (sfVector2f) {1277, 390});
...
{
    put_letter(data, 's', (IntR_t) {145, 206, 6, 10}, (sfVector2f) {1157, 670});
    put_letter(data, 't', (IntR_t) {161, 203, 7, 13}, (sfVector2f) {1277, 670});
    ...
    put_letter(data, 'H', (IntR_t) {125, 88, 6, 13}, (sfVector2f) {1037, 310});
    put_letter(data, 'I', (IntR_t) {144, 88, 4, 13}, (sfVector2f) {1157, 310});
    put_letter(data, 'J', (IntR_t) {158, 88, 6, 13}, (sfVector2f) {1277, 310});
...
void set_letters(data_t *data)
{
    ...
    put_letter(data, 'g', (IntR_t) {113, 189, 6, 13}, (sfVector2f) {917, 590});
    put_letter(data, 'h', (IntR_t) {129, 187, 6, 13}, (sfVector2f) {1037, 590});
    put_letter(data, 'i', (IntR_t) {147, 187, 3, 13}, (sfVector2f) {1157, 590});
    put_letter(data, 'j', (IntR_t) {161, 187, 5, 15}, (sfVector2f) {1277, 590});
    ...
    put_letter(data, 'q', (IntR_t) {113, 206, 6, 12}, (sfVector2f) {917, 670});
    put_letter(data, 'r', (IntR_t) {129, 206, 6, 10}, (sfVector2f) {1037, 670});
    next_letter(data);
}
