...
{
    put_letter(data, '0', (IntR) {15, 139, 7, 13}, (sfVector2f) {317, 390});
    put_letter(data, '1', (IntR) {33, 139, 6, 13}, (sfVector2f) {317, 390});
    put_letter(data, '2', (IntR) {47, 139, 7, 13}, (sfVector2f) {317, 390});
    put_letter(data, '3', (IntR) {63, 139, 6, 13}, (sfVector2f) {317, 390});
    put_letter(data, '4', (IntR) {79, 139, 6, 13}, (sfVector2f) {317, 390});
    put_letter(data, '5', (IntR) {15, 155, 7, 13}, (sfVector2f) {317, 390});
    put_letter(data, '6', (IntR) {31, 155, 7, 13}, (sfVector2f) {317, 390});
    put_letter(data, '7', (IntR) {47, 155, 7, 13}, (sfVector2f) {317, 390});
    put_letter(data, '8', (IntR) {63, 155, 6, 13}, (sfVector2f) {317, 390});
    put_letter(data, '9', (IntR) {79, 155, 6, 13}, (sfVector2f) {317, 390});
}

static void next_put_letter(data_t *data)
{
    put_letter(data, 'L', (IntR) {30, 104, 6, 13}, (sfVector2f) {317, 390});
    put_letter(data, 'M', (IntR) {45, 104, 8, 13}, (sfVector2f) {437, 390});
    put_letter(data, 'N', (IntR) {61, 104, 7, 13}, (sfVector2f) {557, 390});
    put_letter(data, 'O', (IntR) {77, 104, 8, 13}, (sfVector2f) {677, 390});
    put_letter(data, 'P', (IntR) {93, 104, 8, 13}, (sfVector2f) {797, 390});
    put_letter(data, 'Q', (IntR) {109, 104, 8, 13}, (sfVector2f) {917, 390});
    put_letter(data, 'R', (IntR) {125, 104, 7, 13}, (sfVector2f) {1037, 390});
    put_letter(data, 'S', (IntR) {142, 104, 6, 13}, (sfVector2f) {1157, 390});
    put_letter(data, 'T', (IntR) {158, 104, 8, 13}, (sfVector2f) {1277, 390});
    put_letter(data, 'U', (IntR) {14, 120, 7, 13}, (sfVector2f) {195, 470});
    put_letter(data, 'V', (IntR) {30, 120, 8, 13}, (sfVector2f) {317, 470});
    put_letter(data, 'W', (IntR) {45, 120, 8, 13}, (sfVector2f) {437, 470});
...
static void next_letter(data_t *data)
{
    ...
    put_letter(data, 't', (IntR) {161, 203, 7, 13}, (sfVector2f) {1277, 670});
    put_letter(data, 'u', (IntR) {17, 222, 7, 10}, (sfVector2f) {195, 750});
    ...
    put_letter(data, 'C', (IntR) {46, 88, 7, 13}, (sfVector2f) {437, 310});
    put_letter(data, 'D', (IntR) {61, 88, 7, 13}, (sfVector2f) {557, 310});
    put_letter(data, 'E', (IntR) {77, 88, 8, 13}, (sfVector2f) {677, 310});
    put_letter(data, 'F', (IntR) {94, 88, 6, 13}, (sfVector2f) {797, 310});
    put_letter(data, 'G', (IntR) {109, 88, 8, 13}, (sfVector2f) {917, 310});
    put_letter(data, 'H', (IntR) {125, 88, 6, 13}, (sfVector2f) {1037, 310});
    put_letter(data, 'I', (IntR) {144, 88, 4, 13}, (sfVector2f) {1157, 310});
...
void set_letters(data_t *data)
{
    ...
    put_letter(data, 'c', (IntR) {49, 190, 6, 10}, (sfVector2f) {437, 590});
    ...
    put_letter(data, 'l', (IntR) {35, 203, 4, 13}, (sfVector2f) {317, 670});
    put_letter(data, 'm', (IntR) {49, 206, 8, 10}, (sfVector2f) {437, 670});
    put_letter(data, 'n', (IntR) {65, 206, 6, 10}, (sfVector2f) {557, 670});
    put_letter(data, 'o', (IntR) {81, 206, 7, 10}, (sfVector2f) {677, 670});
    put_letter(data, 'p', (IntR) {97, 206, 6, 12}, (sfVector2f) {797, 670});
    put_letter(data, 'q', (IntR) {113, 206, 6, 12}, (sfVector2f) {917, 670});
    put_letter(data, 'r', (IntR) {129, 206, 6, 10}, (sfVector2f) {1037, 670});
    next_letter(data);
}
