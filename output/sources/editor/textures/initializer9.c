...
node_texture *init_texture44(node_texture *texture)
{
    ...
    return init_texture45(texture);
}

node_texture *init_texture43(node_texture *texture)
{
    ...
    return init_texture44(texture);
}

node_texture *init_texture42(node_texture *texture)
{
    ...
    return init_texture43(texture);
}

node_texture *init_texture41(node_texture *texture)
{
