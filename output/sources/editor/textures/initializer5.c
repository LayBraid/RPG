...
node_texture *init_texture24(node_texture *texture)
{
    ...
    return init_texture25(texture);
}

node_texture *init_texture23(node_texture *texture)
{
    ...
    return init_texture24(texture);
}

node_texture *init_texture22(node_texture *texture)
{
