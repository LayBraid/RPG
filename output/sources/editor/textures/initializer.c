...
node_texture *init_textures(void)
{
    ...
    add_next_texture(&texture, set_village_house_top1_0, "village_house_top1_0",470);
    add_next_texture(&texture, set_village_house_top1_1, "village_house_top1_1",471);
    add_next_texture(&texture, set_village_house_top1_2, "village_house_top1_2",472);
    add_next_texture(&texture, set_village_house_top1_3, "village_house_top1_3",473);
    add_next_texture(&texture, set_village_house_top1_4, "village_house_top1_4",474);
    add_next_texture(&texture, set_village_house_top1_5, "village_house_top1_5",475);
    ...
    add_next_texture(&texture, set_village_house1_0, "village_house1_0",482);
    add_next_texture(&texture, set_village_house1_1, "village_house1_1",483);
    add_next_texture(&texture, set_village_house1_2, "village_house1_2",484);
    add_next_texture(&texture, set_village_house1_3, "village_house1_3",485);
    ...
    add_next_texture(&texture, set_village_house2_0, "village_house2_0",486);
    add_next_texture(&texture, set_village_house2_1, "village_house2_1",487);
    add_next_texture(&texture, set_village_house2_2, "village_house2_2",488);
    add_next_texture(&texture, set_village_house2_3, "village_house2_3",489);
    ...
    add_next_texture(&texture, set_village_house3_0, "village_house3_0",490);
    add_next_texture(&texture, set_village_house3_1, "village_house3_1",491);
    add_next_texture(&texture, set_village_house3_2, "village_house3_2",492);
    add_next_texture(&texture, set_village_house3_3, "village_house3_3",493);
