...
node_texture *init_textures(void)
{
    ...
    add_next_texture(&texture, set_caves_entry41_0, "caves_entry41_0",376);
    add_next_texture(&texture, set_caves_entry41_1, "caves_entry41_1",377);
    add_next_texture(&texture, set_caves_entry41_2, "caves_entry41_2",378);
    add_next_texture(&texture, set_caves_entry41_3, "caves_entry41_3",379);
